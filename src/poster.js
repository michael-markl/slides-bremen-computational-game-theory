...
const PhysicalFlowModelBox = () => (
  <CustomBox width={1075} position="relative">
    <SubHeading color={theme.colors.secondary}>
      ...
      <div>
        ...
        <UnorderedList style={{ margin: "0 32px" }}>
          ...
          <ListItem>
            ...
            {Tex`u_i: \mathbb R_{\geq 0} \to \mathbb R_{\geq 0}`}.
          </ListItem>
        </UnorderedList>
        <Definition>
          ...
          <UnorderedList style={{ margin: "0" }}>
            <ListItem>
              edge inflow rates{" "}
              {Tex`f^+_{i,e}:\mathbb R_{\geq 0}\to \mathbb R_{\geq 0}`} for{" "}
  ...
  <CustomBox width={1075}>
    ...
    <Box>
      <UnorderedList margin="0 32px">
        <ListItem>
          The <i>exit time</i> when entering edge {Tex`e`} at time {Tex`\theta`}{" "}
          is given by{" "}
        ...
        <ListItem>
          ...
          where {Tex`\hat q_{i,e}(\theta; \bar\theta; q)`} describes the{" "}
          <i>predicted queue length </i>
          of edge {Tex`e`} at time {Tex`\theta`} as predicted at time{" "}
          {Tex`\bar\theta`} using the historical queue functions {Tex`q`}.
        </ListItem>
        <ListItem>
          The <i>predicted exit time</i> when entering an edge {Tex`e`} at time{" "}
          {Tex`\theta`} is given by{" "}
          {Tex`\hat T_{i,e}(\theta; \bar\theta; q)\coloneqq \theta + \tau_e + \frac{\hat q_{i,e}(\theta; \bar\theta, q)}{\nu_e}`}
          .
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          The <i>predicted earliest arrival</i> at {Tex`t_i`} when starting at
          time {Tex`\theta`} at {Tex`v`} is given by
      ...
      <Definition>
        ...
        {Tex`\hat q = (\hat q_{i,e})_{i\in I, e\in E}`} and a feasible dynamic
        flow {Tex`f`} is a <i>dynamic prediction equilibrium (DPE)</i>, if for
        all edges {Tex`e=vw`} and all {Tex`\theta \geq 0`} it holds that
        {BTex`
...
const ExistenceBox = () => (
  <CustomBox width={1075}>
    ...
    <Definition>
      A predictor {Tex`\hat q_{i,e}`} is <i>continuous</i>, if{" "}
      {BTex`
            \hat q_{i,e} : \mathbb R_{\geq0} \times \mathbb R_{\geq 0} \times C(\mathbb R_{\geq0}, \mathbb R_{\geq0})^{E} \to \mathbb R_{\geq 0},
            `}{" "}
      is continuous from the product topology, where all{" "}
      {Tex` C(\mathbb R_{\geq0}, \mathbb R_{\geq0})`} are equipped with the
      topology induced by the uniform norm, to {Tex`\R_{\geq 0}`}.
    </Definition>
    <Definition>
    ...
    <Definition>
      ...
      {Tex`\hat T_{i,e}(\,\boldsymbol{\cdot}\,;\bar\theta, q)`} is
      non-decreasing for all {Tex`\bar\theta\in \R_{\geq0}`} and{" "}
      {Tex` q\in C(\mathbb R_{\geq0},\mathbb R_{\geq0})^{E}`}.
    </Definition>

    <Theorem>
      If all network inflow rates {Tex`u_i`} are bounded and all predictors{" "}
      {Tex`\hat q_{i, e}`} are continuous, oblivious, and respect FIFO, then
  ...
  <CustomBox width={1075}>
    ...
    <UnorderedList>
      <PredictorListItem
        text={
          <>
            ...
            {Tex`\hat q^{\text{Z}}_{i,e}(\theta;\bar\theta;q) \coloneqq 0`}.
            <br />
            <p style={{ marginTop: "5px" }}>
              Predicted shortest paths always remain the same.
            </p>
          </>
        }
      ...
      <PredictorListItem
        text={
          <>
            ...
            {Tex`\hat q^{\text{C}}_{i,e}(\theta;\bar\theta;q) \coloneqq q_e(\bar\theta)`}
            .
            <p style={{ marginTop: "5px" }}>
              Assumes the current conditions for the future. If all commodities
              use this predictor, a DPE corresponds to an Instantaneous Dynamic
              Equilibrium.
            </p>
          </>
        }
      ...
      <PredictorListItem
        text={
          <>
            ...
            {Tex`\hat q^{\text{L}}_{i,e}(\theta;\bar\theta;q) \coloneqq 
                \left( q_e(\bar \theta)+\partial_-q_e(\bar \theta)\cdot \min\{ \theta-\bar\theta, H \} \right)^+
                `}
            .
            <p style={{ marginTop: "5px" }}>
              Not continuous in {Tex`\bar\theta`} whenever {Tex`\partial_-q_e`}{" "}
              jumps.
            </p>
          </>
        }
      ...
      <PredictorListItem
        text={
          <>
            ...
            >{Tex`\hat q_{i,e}^{\text{RL}}(\theta;\bar\theta; q) \coloneqq
      ...
      <PredictorListItem
        text={
          <>
            <i>The perfect predictor </i>{" "}
            {Tex`\hat q^{\text{P}}_{i,e}(\theta;\bar\theta;q) \coloneqq q_e(\theta)`}
            .
            <p style={{ marginTop: "5px" }}>
              Will always predict the future correctly and is thus not
              oblivious. If all commodities use this predictor, a DPE
              corresponds to a dynamic equilibrium in the full-information
              model.
            </p>
          </>
        }
        figure={(minimize) => <PerfectPredictorSvg minimize={minimize} />}
        compatible={false}
      />
    </UnorderedList>
  </CustomBox>
...
const SimulationBox = () => (
  <CustomBox width={1075}>
    ...
    <UnorderedList>
      ...
      <ListItem>
        We assume that the network inflow rates are piecewise constant with
        finite jumps
      </ListItem>
      <ListItem>
        The extension procedure for one routing interval{" "}
        {Tex`(\bar\theta_k,\bar\theta_{k+1})`} given an equilibrium flow up to
        time {Tex`H = \bar\theta_k`}:
        <div style={{ width: "900px" }}>
          <ThemeProvider theme={{ size: { width: "900px" } }}>
            ...
            >
              <ListItem>
                Gather predictions{" "}
                {Tex`(\hat q_{i,e}(\,\boldsymbol\cdot\,;\bar\theta_k; q))_{i,e}`}{" "}
                for {Tex`\bar\theta_k`}
              </ListItem>
              <ListItem>
              ...
              <ListItem>
                ...
                >
                  Compute maximal {Tex`H'\leq\bar\theta_{k+1}`} such that{" "}
                  {Tex`b_{i,v}^-(\theta)\coloneqq \sum_{e\in\delta_{v}^-} f_{i,e}^-(\theta) + u_i(\theta)\cdot\mathbf{1}_{v=s_i}`}
                  <br /> is constant on {Tex`(H, H')`} for all{" "}
                  {Tex`v\in V, i\in I`}
                </div>
              </ListItem>
              <ListItem>
                <Code> </Code>Equally distribute {Tex`b_{i,v}^-(\theta)`} to the
                outgoing edges lying on shortest paths during {Tex`(H, H')`}
              </ListItem>
              <ListItem>
                <Code> </Code>
                {Tex`H \leftarrow H'`}
      ...
      <ListItem>
        This simulation enables us to generate training data for the linear
        regression predictor {Tex`\hat q^{\text{ML}}_{i,e}`}:
        <UnorderedList>
          <ListItem>
            We use the constant predictor to create sample DPE.
          </ListItem>
          <ListItem>
            This allows the model to estimate the progression of queues when
            agents follow our behavioral model.
          </ListItem>
          <ListItem>
            In small networks, the weights have been trained seperately on each
            edge.
          </ListItem>
          <ListItem>
            In larger networks, a single weight matrix has been learned using
            the collective data of all edges.
          </ListItem>
        </UnorderedList>
      </ListItem>
    </UnorderedList>
...
const ComparingPerformanceBox = () => (
  <CustomBox width={1075}>
    ...
    <UnorderedList>
      ...
      <ListItem>
        Simulations in real-world road traffic networks (centre of Tokyo, Sioux
        Falls) show
        <UnorderedList>
          <ListItem>
          ...
          <ListItem>
            the simulation is capable of computing DPE in large-scale networks.
          </ListItem>
        </UnorderedList>
      </ListItem>
    </UnorderedList>
...
const TimeSeries = () => {
  ...
  const width = 350;
  return (
    <div style={{ position: "relative", height: 1975, left: "20px" }}>
      ...
      >
        A DPE using predictor {Tex`\hat q_{i,e}^L`}.
      </Text>
    </div>
  );
};
  ...
  <Deck theme={theme}>
    <Slide padding={0} backgroundColor="white" textColor={theme.colors.primary}>
      <Heading
        ...
        style={{ margin: "-16px -16px 10px -16px", padding: "32px" }}
      >
        {TITLE}
      </Heading>
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          <Text
            ...
            textAlign="center"
            fontSize="h2"
            style={{ margin: "0.5em", padding: "0px" }}
          >
            Lukas Graf<sup>1</sup>, Tobias Harks<sup>1</sup>, Kostas Kollias
            <sup>2</sup>, and Michael Markl<sup>1</sup>
            <div
              style={{
                fontSize: "0.8em",
                margin: "0.625em",
