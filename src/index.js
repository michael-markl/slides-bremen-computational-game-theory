...
const TITLE = "Prediction Equilibrium for Dynamic Traffic Assignment";
...
const Presentation = () => (
  <Deck theme={theme} template={template}>
      ...
      <Box>
        <div>
          ...
          <UnorderedList style={{ margin: "0 32px" }}>
            ...
            <ListItem>
              commodities {Tex`i\in I`} each with source and sink nodes{" "}
              {Tex`s_i, t_i\in V`} and <br />a network inflow rate{" "}
              {Tex`u_i  \in \mathcal R\coloneqq \{ g\in L^1_{\text{loc}}(\R, \R_{\geq 0}) \mid g_{\vert (-\infty, 0)} \equiv 0  \}`}
              .
            </ListItem>
          </UnorderedList>
          <Appear>
            <Definition>
              ...
              <UnorderedList style={{ margin: "0" }}>
                <ListItem>
                  edge inflow rates {Tex`f^+_{i,e} \in \mathcal R`} for{" "}
                  {Tex`i\in I, e\in E`} and
                </ListItem>
                <ListItem>
                  edge outflow rates {Tex`f^-_{i,e} \in \mathcal R`} for{" "}
                  {Tex`i\in I, e\in E`}.
                </ListItem>
              </UnorderedList>
            </Definition>
          ...
          <Appear>
            <Notation>
              ...
              <Appear tagName="span">{Tex`~~q_e(\theta) \coloneqq \int_0^\theta f^+_e\,\mathrm d\lambda  -  \int_0^{\theta + \tau_e} f^-_e \,\mathrm d\lambda`}</Appear>
            </Notation>
          </Appear>
          <Appear>
            <Definition position="relative">
              ...
              <UnorderedList style={{ margin: "0" }}>
                <ShowcaseFormula
                  ...
                  formula={BTex`\sum_{e\in\delta_v^+} f^+_{i,e}(\theta) - \sum_{e\in\delta_v^-} f^-_{i,e}(\theta) 
              \begin{cases}
          ...
          \end{cases}`}
              ...
              >
                <Appear>
                  ...
                  >
                    <div>{Tex`\begin{rcases}  \\[2em] \end{rcases}`}</div>
                    <Text>
                      A flow {Tex`f`} <i>behaves deterministically</i> on{" "}
                      {Tex`e`} <br />
                      if it fulfills both capacity constraints.
                    </Text>
                  </div>
                </Appear>
              </Box>
    ...
    <CustomSlide section="I. The Flow Model">
      <SubHeading>The Meaning of “Deterministic Queuing Model”</SubHeading>
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        <Appear>
          <Theorem width="800px" margin={64}>
            Given a family{" "}
            {Tex`f^+ = (f_{i,e}^+)_{i\in I, e\in E}\in\mathcal R^{I\times E}`}{" "}
            of inflow rates, there exists a unique family{" "}
            {Tex`f^- = (f_{i,e}^-)_{i\in I, e\in E}\in\mathcal R^{I \times E}`}{" "}
            of outflow rates such that {Tex`(f^+, f^-)`} behaves
            deterministically.
          </Theorem>
        </Appear>
        ...
        <Appear>
          <Theorem width="800px">
            Let {Tex`(f^+, f^-)`} and {Tex`(g^+, g^-)`} behave deterministically
            on an edge {Tex`e\in E`}. If their inflow rates on {Tex`e`} coincide
            up to some time {Tex`H\in\R_{\geq0}`}, i.e.
            {BTex`
        \forall i\in I:\quad f^+_{i,e}\mid_{(-\infty, H)}~\overset{a.e.}{=} g^+_{i,e}\mid_{(-\infty, H)},
        `}
            then the corresponding queue functions {Tex`q_e^f`} and {Tex`q_e^g`}{" "}
            coincide on {Tex`(-\infty, H]`}. Moreover, their outflow rates on{" "}
            {Tex`e`} coincide up to time{" "}
            {Tex`T_e(H) \coloneqq H + \tau_e + \frac{q_e(H)}{\nu_e}`}, i.e.
            {BTex`
        \forall i\in I: \quad f^+_{i,e}\mid_{(-\infty, T_e(H))}~\overset{a.e.}{=} g^-_{i,e}\mid_{(-\infty, T_e(H))}
        .
      `}
          </Theorem>
        </Appear>
    ...
    <CustomSlide section="I. The Flow Model">
      ...
      <Box>
        <UnorderedList margin="0 32px">
          ...
          <Appear>
            <ListItem>
              Each commodity {Tex`i\in I`} is equipped with a set of{" "}
              <i>predictors</i>{" "}
              {BTex`
          \hat q_{i,e} : \mathbb R \times \mathbb R \times (\mathcal R\times \mathcal R)^{I\times E} \to \mathbb R_{\geq 0},
          \quad
          (\theta, \bar\theta, f)\mapsto\hat q_{i,e}(\theta; \bar\theta; f),`}
              where {Tex`\hat q_{i,e}(\theta; \bar\theta; f)`} describes the{" "}
          ...
          <Appear>
            <ListItem>
              ...
              {Tex`\hat T_{i,e}(\theta; \bar\theta; f)\coloneqq \theta + \tau_e + \frac{\hat q_{i,e}(\theta; \bar\theta, f)}{\nu_e}`}
              .
            </ListItem>
          </Appear>
          <Appear>
          ...
          <Appear>
            <ListItem>
              The <i>predicted earliest arrival</i> at {Tex`t_i`} when starting
              at time {Tex`\theta`} at {Tex`v`} is given by{" "}
              {Tex`\displaystyle ~\hat l_{i,v}(\theta; \bar\theta; f)
            \coloneqq \min_{P\text{ simple } v\text{-}t_i\text{-path}} \hat T_{i,P}(\theta;\bar\theta;f).
            `}
            </ListItem>
          </Appear>
          <Appear>
            <ListItem style={{ marginTop: "15px", marginLeft: "10px" }}>
              ...
              time {Tex`\theta`} is given by{" "}
              {Tex`\hat \Delta_{i,e}(\theta; \bar\theta; f)
            \coloneqq \hat l_{i,w}(\hat T_{i,e}( \theta;\bar\theta; f); \theta; f) - \hat l_{i,v}(\theta;\bar\theta; f).
            `}
            </ListItem>
          </Appear>
        </UnorderedList>
        <Appear>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Definition width="800px">
              ...
              {Tex`\hat q = (\hat q_{i,e})_{i\in I, e\in E}`} and a feasible
              ...
              {BTex`
              f^+_{i,e}(\theta) > 0 \implies \hat\Delta_{i,e}(\theta,\theta, f) = 0.
          `}
            </Definition>
          </div>
        </Appear>
    ...
    <CustomSlide section="I. The Flow Model">
      <Example>
        ...
        <UnorderedList>
          <Appear>
            <ListItem>
              We are given a single commodity with network inflow rate{" "}
              {Tex`u\equiv 2`} and predictor{" "}
    ...
    <CustomSlide section="II. Existence of DPE">
      ...
      <Appear>
        <Definition>
          A predictor {Tex`\hat q_{i,e}`} is <i>{Tex`p`}-continuous</i> with{" "}
          {Tex`p \geq 1`}, if for all {Tex`M > 0`} and compact intervals{" "}
          {Tex`D`} the mapping{" "}
          {BTex`
       \mathcal A: \quad f^+ \mapsto \hat q_{i,e}(${emptyArg},${emptyArg}, f)
       ,`}{" "}
          where {Tex`f`} is the deterministic flow with inflow rates {Tex`f^+`},
          is sequentially weak-strong continuous from{" "}
          {Tex`L^p([0, M])^{I\times E}`} to {Tex`C([0,M]\times D)`}.
        </Definition>
      </Appear>
      <Appear>
        <Definition>
          A predictor {Tex`\hat q_{i,e}`} is <i>oblivious</i>, if for all{" "}
          {Tex`\bar\theta \in\mathbb R_{\geq0}`} it holds{" "}
          {Tex`
        \quad\forall f,f'\colon\quad
    f_{\hspace{.07em}\vert\hspace{.07em}[0, \bar\theta]^{I\times E}} ~\overset{a.e.}{\underset{c.w.}{=}}~ f'_{\hspace{.07em}\vert\hspace{.07em}[0, \bar\theta]^{I\times E}}
    \implies
    \hat q_{i,e}(\,\boldsymbol{\cdot}\,;\bar\theta;f)=\hat q_{i,e}(\,\boldsymbol{\cdot}\,;\bar\theta;f').
        `}
        </Definition>
      </Appear>
      ...
      <Appear>
        <Definition>
          A predictor {Tex`\hat q_{i,e}`} <i>respects FIFO</i>, if{" "}
          {Tex`\hat T_{i,e}(\,\boldsymbol{\cdot}\,;\bar\theta, f)`} is
      ...
      <Appear>
        <Theorem>
          If all network inflow rates fulfill{" "}
          {Tex`u_i\in L^p_{\text{loc}}(\mathbb R, \mathbb R_{\geq 0})`} and all
    ...
    .`}
      ...
      <Appear>
        <Lemma margin="0 32px">
          ...
          {Tex`f^+\in L_{\text{loc}}^{p}(\mathbb R_{\geq0},\mathbb R_{\geq0})^{I\times E}`}
          ...
          {Tex`h^+\in L_{\text{loc}}^{p}(\mathbb R, \mathbb R_{\geq0})^{I\times E}`}{" "}
          hold.
        </Lemma>
      </Appear>
      <Appear>
      ...
      <UnorderedList margin="0px 16px">
        ...
        <Appear>
          <ListItem>
            The mapping{" "}
            {Tex`\mathcal A: f^+ \mapsto (\theta\mapsto \hat\Delta_{i,e}(\theta,\theta,f))_{i,e}`}{" "}
            is sequentially weak-strong continuous from{" "}
            {Tex`L^p([H,H+\alpha])^{I\times E}`} to{" "}
            {Tex`L^q([H,H+\alpha])^{I\times E}`}.
          </ListItem>
        </Appear>
        <Appear>
          <ListItem>
            We use{" "}
            {Tex`\displaystyle~ K\coloneqq \left\{ f^+\in L^p([H, H+\alpha], \mathbb R_{\geq0})^{I\times E} \,\middle|\,  \begin{array}{c r c l}
                \forall i\in I, v\in V\setminus\{t_i\} : & \sum_{e\in\delta_{v}^+} f^+_{i,e}   & \overset{a.e.}{=} & b_{i,v}^+,  \\
                \forall i\in I :                         & \sum_{e\in\delta_{t_i}^+} f^+_{i,e} & \overset{a.e.}{\leq}  & b_{i,t_i}^+ \\
            \end{array} \right\}.`}
          </ListItem>
        </Appear>
        <Appear>
    ...
    <CustomSlide section="II. Existence">
      ...
      <Lemma>
        ...
        {BTex`
            \hat q_{i,e}(\theta,\bar\theta, f) = \gamma_{i,e}\left(
                  \theta,
                  \bar\theta,
                  F_{I\times E}^{+,f},
                  F_{E}^{-,f},
                  ...
                  \right)
                  \quad\quad
                  \text{with~~$F_{I\times E}^{+,f} = (\xi \mapsto \int_0^\xi f_{i,e}^+\,\mathrm d\lambda)_{i,e}$,~~$F_{E}^{+,f} = (\xi \mapsto \int_0^\xi f_{e}^-\,\mathrm d\lambda)_{e}$}
          `}
        and if {Tex`\gamma_{i,e}`} is continuous from{" "}
        {Tex`\mathbb R\times \mathbb R\times C(\mathbb R_{\geq0}, \mathbb R_{\geq 0})^{(I\times E)+E+E}`}{" "}
        ...
        <PredictorListItem
          text={
            <>
              ...
              {Tex`\hat q^{\text{Z}}_{i,e}(\theta;\bar\theta;f) \coloneqq 0`}.
              <br />
              <Appear>
        ...
        <PredictorListItem
          text={
            <>
              ...
              {Tex`\hat q^{\text{C}}_{i,e}(\theta;\bar\theta;f) \coloneqq q^f_e(\bar\theta)`}
              .<br />
              <Appear>
        ...
        <PredictorListItem
          text={
            <>
              ...
              {Tex`\hat q^{\text{L}}_{i,e}(\theta;\bar\theta;f) \coloneqq 
        ...
        <PredictorListItem
          text={
            <>
              ...
              >{Tex`\hat q_{i,e}^{\text{RL}}(\theta;\bar\theta; f) \coloneqq
\Big( q^f_e(\bar\theta) + \frac{q^f_e(\bar\theta) - q^f_e(\bar\theta - \delta)}{\delta} \cdot \min\{ \theta - \bar\theta, H \} \Big)^+
        ...
        <PredictorListItem
          text={
            <>
              ...
              {Tex`\hat q_{i,e}^{\text{ML}}`} linearly interpolates the points{" "}
              <br />
      ...
      <UnorderedList style={{ marginTop: 0 }}>
        <Appear>
          <ListItem style={{ marginTop: 16 }}>
            ...
            {Tex`\hat q_{i,e}(\theta;\bar\theta;f)\coloneqq q^f_e(\bar\theta)`},
        ...
        <Appear>
          <ListItem style={{ marginTop: 32 }}>
            ...
            {Tex`\hat q_{i,e}(\theta;\bar\theta;f)\coloneqq q^f_e(\theta)`},
    ...
    <CustomSlide intro section="IV. Computational Study">
      ...
      <UnorderedList>
          ...
          <ListItem>
            ...
            <Appear>
              <Definition>
                ...
                {BTex`
            f_{i,e}^+(\theta) > 0 \implies \hat\Delta_{i,e}(\lfloor \theta / \varepsilon\rfloor\cdot \varepsilon, \lfloor \theta / \varepsilon\rfloor\cdot \varepsilon, f) = 0.
          `}
              </Definition>
            </Appear>
          </ListItem>
        ...
        <Appear>
          <ListItem>
            We assume that the network inflow rates {Tex`u_i`} are piecewise
              ...
              <ThemeProvider theme={{ size: { width: "1200px" } }}>
                ...
                >
                  <Appear>
                    <ListItem>
                      Gather predictions{" "}
                      {Tex`(\hat q_{i,e}(${emptyArg};\bar\theta_k; f))_{i,e}`}{" "}
                      for {Tex`\bar\theta_k`}
                    </ListItem>
                  </Appear>
                  <Appear>
                    <ListItem>
                      Compute all shortest {Tex`v`}-{Tex`t_i`}-paths at time{" "}
                  ...
                  <Appear>
                    <ListItem>
                      ...
                      {Tex`b_{i,v}^-(\theta)\coloneqq \sum_{e\in\delta_{v}^-} f_{i,e}^-(\theta) + u_i(\theta)\cdot\mathbf{1}_{v=s_i}`}{" "}
                  ...
                  <Appear>
                    <ListItem>
                      <Code> </Code>Equally distribute {Tex`b_{i,v}^-(\theta)`}{" "}
